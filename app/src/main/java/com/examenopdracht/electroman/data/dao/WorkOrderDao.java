...
public interface WorkOrderDao {
    ...
    @Query("SELECT COUNT(*) FROM WorkOrder WHERE city = :city AND device = :device AND customerName = :customerName")
    int doesWorkOrderExist(String city, String device, String customerName);
